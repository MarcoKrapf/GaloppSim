...
'        End With
        ...
        'Michael
        Call AlignObject(img_info_team04, 6, 144, 348, 108)
        Call AlignObject(lbl_info_team04a, 156, 18, 354, 102, 12)
        Call AlignObject(lbl_info_team04b, 174, 24, 354, 102)
        ...
        'Natalie
        Call AlignObject(img_info_team06, 210, 144, 120, 108)
        Call AlignObject(lbl_info_team06a, 360, 18, 126, 102, 12)
        Call AlignObject(lbl_info_team06b, 378, 24, 126, 102)

        'Atanas
        Call AlignObject(img_info_team07, 210, 144, 234, 108)
        Call AlignObject(lbl_info_team07a, 360, 18, 240, 102, 12)
        Call AlignObject(lbl_info_team07b, 378, 24, 240, 102)
        ...
        'Enno
        Call AlignObject(img_info_team09, 414, 144, 6, 108)
        Call AlignObject(lbl_info_team09a, 564, 18, 12, 102, 12)
        Call AlignObject(lbl_info_team09b, 582, 24, 12, 102)
