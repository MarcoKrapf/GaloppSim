VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmTracksSpaceRace 
   Caption         =   "UserForm1"
   ClientHeight    =   5910
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   9720
   OleObjectBlob   =   "frmTracksSpaceRace.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "frmTracksSpaceRace"
...
Private Sub cmdSpace01_Click()
    ...
    With frmStart
        ...
        .lblS4.caption = strPlanetSurfaceText
        .lblS4.BackColor = objRace.TRACK_COLOUR
    End With
