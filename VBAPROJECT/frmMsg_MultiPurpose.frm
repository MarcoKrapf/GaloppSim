...
Private Sub UserForm_Initialize()
    ...
    'Adjust the buttons
        Select Case g_strMsgButtons
            Case "OK"
                Call AdjustButton(cmdMsgOK, GetText(g_arr_Text, "BTN014"), 0)
            Case "CancelOK"
                Call AdjustButton(cmdMsgOK, GetText(g_arr_Text, "BTN014"), 0)
                Call AdjustButton(cmdMsgCancel, GetText(g_arr_Text, "BTN015"), cmdMsgOK.Width + 5)
            Case "YesNo"
                Call AdjustButton(cmdMsgYes, GetText(g_arr_Text, "BTN016"), cmdMsgNo.Width + 5)
                Call AdjustButton(cmdMsgNo, GetText(g_arr_Text, "BTN017"), 0)
        End Select
