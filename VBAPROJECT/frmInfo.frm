...
Private Sub UserForm_Initialize()
    ...
    'Prepare the algorithms page
        With multiPage_algo
            ...
            .Visible = True
        End With
        chk_info_algorithms01.Value = g_blnStopAlgorithms 'set the checkbox value
        With lbl_info_algorithms01
            .Caption = GetTxt(g_arrTxtInfo, "ALGO04")
            .Font.Size = 20
            .Font.Bold = True
...
Private Sub chk_info_algorithms01_Click()
    g_blnStopAlgorithms = chk_info_algorithms01.Value
    If g_blnStopAlgorithms = True Then
